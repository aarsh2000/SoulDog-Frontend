  ...
  const body = (
    <div style={modalStyle} className={classes.paper}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <select onChange={handleFormAge} style={{ width: '100%' }}>
          {ages.map((x, y) => (
        ...
        <RadioGroup
          ...
          aria-label="position"
          name="position"
          defaultValue="AggressionLow"
          onChange={handleFormAggr}
        >
          <FormControlLabel
            value="AggressionLow"
        ...
        <RadioGroup
          ...
          aria-label="position"
          name="position"
          defaultValue="MaintenanceLow"
          onChange={handleFormMaint}
        >
          <FormControlLabel
        ...
        <RadioGroup
          ...
          aria-label="position"
          name="position"
          defaultValue="EnergyLow"
          onChange={handleFormEnergy}
        >
          <FormControlLabel
            value="EnergyLow"
            control={<Radio color="primary" />}
